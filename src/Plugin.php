...
class Plugin
{
    public static function boot()
    {
        ...
        $menu          = new Menu($deskPage, $settingsPage, $presetsPage);
        $metaBox       = new MetaBox($postMeta, $shortenerClient, $settings);
        $ajax          = new AjaxController($providerManager, $validator, $draftService, $shortenerClient, $postMeta, $settings, $logger, $promptPresets);
